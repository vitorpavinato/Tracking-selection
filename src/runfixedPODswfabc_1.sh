...
do 
   ${wfabc_folder}/wfabc_1 -nboots 10000 -nthreads 8 ${INFOLDER}/wfabc_input_sample_${i}.txt | awk -v i="$i" 'BEGIN{FS="\t"} {print i, $1, $2}' >> ${OUTFOLDER}/wfabc_1_output_mutation_neutral.txt
done
