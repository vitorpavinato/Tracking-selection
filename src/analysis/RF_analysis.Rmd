...
# select randomly 1000 random PODs
random1000_rows <- sample(x=1:1877, size = 1000, replace = FALSE)

#save(random1000_rows,
#     file=paste0("~/My_repositories/Tracking-selection/results/pipeline_v5/random1000_rows",".RData"))
#load(file=paste0("~/My_repositories/Tracking-selection/results/pipeline_v5/random1000_rows",".RData"))
```
...
hist(logitaverageGenload_2, freq = TRUE, xlab = expression(logit(italic(bar(L)))), main = "", col = "#bdbdbd")
...
hist(logitpopstrongmsel_2, freq = TRUE, xlab = expression(paste("Pr mutations with"," ", italic(N[s]) , " > 1")), main = "", col = "#bdbdbd")
...
hist(logtheta2, freq = TRUE, xlab = expression(log[10](italic(theta[2]))), main = "", col = "#bdbdbd")
...
plot(x    = logtheta2,
     ...
     xlim = c(-2,6),
     ylim = c(-2,6),
     main = expression(log[10](italic(theta[2]))),
     cex.axis = 1.2,
     cex.lab  = 1.5)
abline(a=0, b=1, col = "green")
```
