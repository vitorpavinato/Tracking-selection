...
#### Likelihood of strongly selected mutations given the Ne of sampling period
...
hist(probstrongMsel, freq = TRUE, xlab = expression(paste("Likelihood of mutations with"," ", italic(N[s]) , " > 1")), main = "", col = "#bdbdbd")
