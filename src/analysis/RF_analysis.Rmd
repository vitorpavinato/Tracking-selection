...
load("/home/pavinato/My_repositories/Tracking-selection/results/pipeline_v5/Cluster_data/Tracking-selection-model1.0.1g/results/pooled_reftable_1.RData")
...
save(pooled_reftable_model_1, file=paste0("/home/pavinato/My_repositories/Tracking-selection/results/pipeline_v5/Cluster_data/Tracking-selection-model1.0.1g/results/pooled_reftable_model_1",".RData"))
...
save(random_pods, file=paste0("/home/pavinato/My_repositories/Tracking-selection/results/pipeline_v5/Cluster_data/Tracking-selection-model1.0.1g/results/random_pods",".RData"))
...
global_sumstats <- pooled_reftable_model_1[-random_pods, -c(1:105)]
...
##Things that are working - for the First version of the Manuscript
...
cor(pooled_reftable_model_1$POPPrStrongMSel[-random_pods], pooled_reftable_model_1$SAMPrStrongMSel[-random_pods])

plot(x = pooled_reftable_model_1$POPPrStrongMSel[-random_pods], 
     y = pooled_reftable_model_1$SAMPrStrongMSel[-random_pods], 
     xlab = "POPPrStrongMSel",
     ylab = "SAMPrStrongMSel")
abline(lm(pooled_reftable_model_1$SAMPrStrongMSel[-random_pods] ~ pooled_reftable_model_1$POPPrStrongMSel[-random_pods]), col="#cb181d")

# PrPOPStrongMSel
prPOPStrongMSel <- pooled_reftable_model_1[-random_pods, "POPPrStrongMSel"]
...
reg_logpopstrongmsel <- regAbcrf(formula = logpopstrongmsel~.,
                                 data    = data.frame(logpopstrongmsel, global_sumstats_logpopstrongmsel), # try with the full reftable instead of the one  removed 0
                                 ntree   = 1000,
                                 paral   = T,
                                 ncores  = 28)
...
prRSel <- pooled_reftable_model_1[-random_pods, "PrGWSel"] * pooled_reftable_model_1[-random_pods, "PrMSel"]
  
logthetaS <- log10(4 * pooled_reftable_model_1[-random_pods, "meanNe2"] * (pooled_reftable_model_1[-random_pods, "mu"] * prRSel) * genomeS)
...
meanNe2ncs <- meanNe2/ncs
logmeanNe2ncs <- log10(meanNe2ncs)
...
logmu <- log10(pooled_reftable_model_1[-random_pods, "mu"])
...
global_sumstats_randompods <- pooled_reftable_model_1[random_pods, -c(1:105)]
...
## Random PODs
log_radnompods_popstrongmsel <- log10(pooled_reftable_model_1[random_pods, "POPPrStrongMSel"])
...
posterior_radnompods_logpopstrongmsel <- predict(object        = reg_logpopstrongmsel,
                                                    ...
                                                    ncores     = 28,
                                                    rf.weights = T)
#(posterior_radnompods_popstrongmsel)
...
## Random PODs
prRSel_randompods <- pooled_reftable_model_1[random_pods, "PrGWSel"] * pooled_reftable_model_1[random_pods, "PrMSel"]

log_radnompods_thetaS <- log10(4 * pooled_reftable_model_1[random_pods, "meanNe2"] * (pooled_reftable_model_1[random_pods, "mu"] * prRSel_randompods) * genomeS)
...
plot(x    = log_radnompods_meanNe2, 
     ...
     xlim = c(0,4),
     ylim = c(0,4),
     xlab = expression(psi[3]), 
     ylab = expression(tilde(psi[3])),
     main = "Expected",
     pch  = 1,
     cex.axis = 1.2,
     cex.lab  = 1.5)
...
selection <- ifelse(pooled_reftable_model_1[-random_pods, "POPPrStrongMSel"] == 0, "N", "S")
table(selection)
...
# prediction error
class_selection$model.rf$prediction.error
...
selection_pods <- ifelse(pooled_reftable_model_1[random_pods, "POPPrStrongMSel"] == 0, "N", "S")
